...
const Profile = () => {
  ...
  const handleClick = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (event.target.checked) {
      ...
      const familyInfoRow = document.querySelector('.familyHiddenRow') as HTMLElement
  ...
  const handleClick3 = (event: React.ChangeEvent<HTMLInputElement>) => {
    if (event.target.checked) {
      ...
      const salaryInfoRow = document.querySelector('.salaryHiddenRow') as HTMLElement
  ...
  const handleClick4 = (event: React.ChangeEvent<HTMLInputElement>) => {
    if (event.target.checked) {
      ...
      const CTCHiddenRow = document.querySelector('.CTCHiddenRow') as HTMLElement
  ...
  const onButtonClick2 = (
    ...
    setModalIsOpen(true)
    setTimeout(() => {
      const var1 = document.getElementById(
        "common-modal"
      ) as HTMLElement
          ...
          >
            <thead>
              <tr>
                ...
                <th className="familyHidden" data-testid ="famCol">Family Information</th>
