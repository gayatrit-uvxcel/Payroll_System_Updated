      ...
      <div className="container-fluid pfEnrolledListContainer">
        <div className="row justify-content-center">
          <div className="col-lg-11">
            ...
            <h2 className="text-center">List of Active PF Employees</h2>
            <div className="row justify-content-center">
              ...
              {/* <div className="col-lg-2">
                <input
                  ...
                  id="address"
                  value="show"
                  onChange={event => tableColumnHideShow("address")}
                />{" "}
                <label htmlFor="date&time" className="form-label">
                  Address
                </label>
              ...
              <table className="table table-bordered css-serial">
                <thead>
                  <tr>
                    ...
                    <th className="heading" id="aadhar_head">Aadhar Number</th>
                    <th className="heading" id="panNum_head">Pan Number</th>
                      ...
                      if (record.pfStatus === "Active") {
                        return (
                          <tr key={Index}>
                            ...
                            <td className="dobOfEmp">{indianDate(record.empDob)}</td>
                            <td>{record.empId}</td>
                            <td className="aadhar">{record.aadharNumber}</td>
                            <td className="panNum">{record.panNumber}</td>
                            <td>
                              <input
                                name="bankName"
                            ...
                            <td>
                              ...
                              ></i>
                              <i
                                className="bi bi-check-circle-fill save-btn editIcon data-toggle=modal data-target=#myModal"
                                style={{ display: "none" }}
                                onClick={e => {
                            ...
                            <td className="creationDate">{`On ${indianDate(record.createdby?.date)} By ${record.createdby?.empId
                              } `}</td>
                            <td className="updationDate">
