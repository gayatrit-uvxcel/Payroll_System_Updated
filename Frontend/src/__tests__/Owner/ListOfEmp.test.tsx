...
import ListOfEmp from "../../pages/Owner/listOfEmp"
import { act,waitFor } from "@testing-library/react";
// import {allUserData} from "../../__mocks__/apiFuc"
// import getAllEmployees from "../../pages/Owner/listOfEmp"
// import * as apiAllFunc from "../../services/apiFunction"


// jest.mock("../../services/apiFunction",()=>{
//     allUserData
//     return {
//         "success": true,
//         "employeeData": [
...
describe("testing list of employee in owner login",()=>{

    beforeAll(()=>server.listen())
    afterEach(()=>server.resetHandlers())
    afterAll(()=>server.close())
    it("all user list is rendering here", async ()=>{
        // const fetchDataMock = jest.spyOn(apiAllFunc,"allUserData")  // Create a spy on the fetchData function
        customeServerCall()

        // apiAllFunc.allUserData.mockResolvedValue(mockData)

        // fetchDataMock.mockImplementation(()=>Promise.resolve(mockData))

        // allUserData
        // allUserData.mockResolvedValue(mockData)

        
        
        
        const {debug,findByText} = render(<ListOfEmp />,{route:"/Owner/listOfEmp"})
        
        // await waitFor(() => {
        //     // Simulate state update inside act
        //     act(() => {
        ...
        // expect(allUserData).toHaveBeenCalled();
